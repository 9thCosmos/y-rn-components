...
export const screen = finalRatio;
export const convertX: (width: number) => number = (width: number) => (isWeb ? width : width * HRatio);
export const convertY: (height: number) => number = (height: number) => (isWeb ? height : height * VRatio);
export const convert: (number: number) => number = (number: number) => (isWeb ? number : number * screen);
